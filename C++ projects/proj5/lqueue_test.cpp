...
int main () {
  ...
  *newLQ3 = *newLQ1;
  ...
  cout << "Test 8 - is empty" << endl;

  if (newLQ1->IsEmpty() == false){
  ...
  cout <<" front is: "<<newLQ1->Front()<<endl;
  cout <<"\n"<<endl;
  ...
  cout << "Test 10 - Test Destructor" << endl;
  ...
  delete newLQ3;
  cout << "End Test 10 - Destructors" << endl;
  return 0;
}
